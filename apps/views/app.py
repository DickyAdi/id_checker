...
class App(tk.Tk):
    def __init__(self, width, height, app_controller:'app_controller'):
        ...
        self.nama_pasangan = component.entry_input(form_frame, 'nama_pasangan', 'Nama pasangan', 7, 0,  state='disabled', required=False)
        self.kolektibilitas = component.combo_input(form_frame, 'kolektibilitas', 'Kolektibilitas', 8, 0,  state='disabled', required=True)
        self.keterangan = component.text_input(form_frame, 'keterangan', 'Keterangan', 9, 0,  state='disabled', required=False)
