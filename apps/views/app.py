...
class App(tk.Tk):
    def __init__(self, width, height, app_controller:'app_controller'):
        ...
        self.corporate_logo = image_label(self.head_frame, './assets/img/logo_BJA_PNG(resize).png', 0, 0) #for compiled version
        # self.corporate_logo = image_label(self.head_frame, 'apps/assets/img/logo_BJA_PNG(resize).png', 0, 0) #for running via code editor
