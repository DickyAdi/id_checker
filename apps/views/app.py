...
class App(tk.Tk):
    def __init__(self, width, height, app_controller:'app_controller'):
        ...
        #form
        self.nik = input_component.entry_input(form_frame, 'nik', 'NIK', 2, 0, required=True)
        self.nama = input_component.entry_input(form_frame, 'nama', 'Nama', 3, 0, state='disabled', required=True)
        self.tanggal_lahir = input_component.entry_input(form_frame, 'tanggal_lahir', 'Tanggal lahir', 4, 0,state='disabled', required=True)
        ...
        self.file_upload = input_component.entry_input(csv_frame, 'csv','File CSV', row=0, col=0, required=True)
